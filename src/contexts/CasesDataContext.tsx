...
export const defaultCaseData: CaseDataType = {
    ...
    GH10Sunday: '',
    GH11HoursPerSession: '',
    GH12AccessibilityTools: [],
    GH13SensoryPreferences: '',
    GH14ScreenSizePref: '',
    GH15ScreenDistPref: '',
    GH16ChoosetoPlay: [],
    GH17MotivatesNewGame: [],
    GH18MotivatesNewGame: [],
    GH19NoGamingExplanation: '',
    GH20aVisualAcuityInfo: '',
    GH20bVisualAcuityInfo: '',
    GH21ScreenDistPref: '',
    GH22CorrectiveProcedures: [],
    GH23ColorVision: '',
    GH25Age: '',
    GH26BiologicalSexAtBirth: '',
    GH27CurrentBiologicalSex: '',
    GH28GenderIdentity: [],
    GH29Race: [],
    GH30HispanicLatinoOrigin: '',
    // Fatigue Severity
    FSV1Motivation: '',
    FSV2Exercise: '',
    FSV3EasilyFatigued: '',
